...
- **By student, per unit:** average of their 0/1 over the unit → **4-tier comprehension band**: Emerging `<0.5` · Developing `≤0.75` · Meeting `<0.9` · In-depth `≥0.9`; **"Incomplete"** when `<80%` of the unit's tasks are scored.
