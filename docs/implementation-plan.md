...
- [ ] **20. Share Power Apps** directly with 5–10 pilot teachers *(Manual — Power Apps share dialog)*. Pilot uses direct sharing only — the Teams app catalog embed is deferred to full rollout (Step 27).
...
- **Hard deadline**: Steps 1–20 must be complete by June 2025 for pilot launch
